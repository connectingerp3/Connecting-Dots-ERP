...
export const coursesData = {
  ...
  "sap-fico": {
    ...
    header: {
      ...
      description:
        "Enroll in the best SAP FICO course in {city} and master financial accounting and controlling with expert-led training. Our SAP FICO training in {city} offers real-time Training, industry-relevant curriculum, and 100% placement support to help you build a successful career in SAP finance modules.",
      backgroundVideo: "https://res.cloudinary.com/dwlw1nykn/video/upload/v1763380067/resh2_eiqhsq.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/Amcads_r5ae7r.avif" },
        { name: "Infosys", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379565/infosys_gkmecl.avif" },
        { name: "Cognizant", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379565/cognyzent_ffiqh9.avif" },
        { name: "TCS", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/TCS_st6svw.avif" },
        { name: "IBM", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/IBM_ucsybi.avif" },
      ],
      buttons: [
  ...
  it: {
    ...
    header: {
      ...
      backgroundVideo: "https://res.cloudinary.com/dwlw1nykn/video/upload/v1763380020/resh5_ntu85r.mp4 ",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/Amcads_r5ae7r.avif" },
  ...
  "data-visualization": {
    ...
    header: {
      ...
      backgroundVideo: "https://res.cloudinary.com/dwlw1nykn/video/upload/v1763380082/resh4_pnsb0k.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/Amcads_r5ae7r.avif" },
  ...
  "digital-marketing": {
    ...
    header: {
      ...
      backgroundVideo: "https://res.cloudinary.com/dwlw1nykn/video/upload/v1763379998/original-533b63432abbda9fe6902cd5f68a9f95_kruwuy.webm",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
       // Used in: Header carousel/logos
        { name: "Amdocs", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/Amcads_r5ae7r.avif" },
  ...
  "hr-training": {
    ...
    header: {
      ...
      backgroundVideo: "https://res.cloudinary.com/dwlw1nykn/video/upload/v1763380017/resh1_xzfm1t.mp4",
      features: ["Live Class", "1:1 mentorship", "Industry projects"],
      alumni: [
        // Used in: Header carousel/logos
        { name: "Amdocs", logo: "https://res.cloudinary.com/dwlw1nykn/image/upload/v1763379566/Amcads_r5ae7r.avif" },
